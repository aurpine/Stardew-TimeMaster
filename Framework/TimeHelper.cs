...
namespace TimeMaster.Framework
{
    ...
    internal class TimeHelper
    {
        ...
        *********/
        ...
        public static double CurrentDefaultTickInterval => Game1.realMilliSecondsPerGameTenMinutes + (Game1.MasterPlayer.currentLocation?.getExtraMillisecondsPerInGameMinuteForThisLocation() ?? 0);
